...
{
    private static final String ANG_RATE_DEF = "http://sensorml.com/ont/swe/property/AngularRate";
    private static final String ANG_RATE_CRS = "#" + AndroidSensorsDriver.LOCAL_REF_FRAME;
