...
public class TestSensorHub
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        gtr.getObservables().add("http://myonto/def/videoFrame");
        gtr.setVersion("2.0");        
        ...
        final int width = ((DataArray)grtResp.getResultStructure()).getArrayComponent().getComponentCount();
        ...
        gt.getObservables().add("http://myonto/def/videoFrame");
        gt.setVersion("2.0");                
        ...
        Runnable job = new Runnable() {
            ...
            public void run()
            {
                try
                {
                    ...
                    InputStream is = new BufferedInputStream(utils.sendGetRequest(gt).getInputStream());
                    ...
                    while ((data = parser.parseNextBlock()) != null)
                    {
                        ...
                        Raster raster = Raster.createRaster(img.getSampleModel(), buf, new Point(0,0));
                        img.setData(raster);
